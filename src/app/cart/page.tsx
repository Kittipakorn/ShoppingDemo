  ...
  return (
    <div>
      <div className="bg-slate-200 min-h-[100vh]">
        <Link href="/">
          <div className="pl-5 pt-5">
            <svg className="w-10" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" fill="#000000">
        ...
        {cart.length === 0 ? (
          ...
          <div className="grid grid-rows gap-4 p-10">
            {cart.map((item) => (
              <div key={item.id} className="flex gap-5 bg-white rounded-lg p-5">
      ...
      <Modal show={showModal} onClose={handleCloseModal}>
        {qrCode && <img src={qrCode} alt="QR Code for Payment" className="m-auto" />}
      </Modal>
    </div>
  );
}
